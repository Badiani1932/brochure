export const gelatoFlavors = [
  ...
  },
  {
    ...
    seasons: ["tutti"],
    image: "../assets/gelato/STRACCIATELLA ALLA MENTA/stracciatella_menta.webp",
    detailImage: "../assets/gelato/STRACCIATELLA ALLA MENTA/stracciatella_menta-2.webp",
  ...
  {
    id: "sorbetto-cioccolato-venezuela",
    nameKey: "flavor.sorbettoCioccolatoVenezuela",
    label: "Cioccolato Monorigine Venezuela",
    seasons: ["tutti"],
    image: "../assets/gelato/cioccolato monorigine venezuela/cioccolatomonoriginevenezuela.webp",
    detailImage: "../assets/gelato/cioccolato monorigine venezuela/cioccolatomonoriginevenezuela-2.webp",
    description: "Sorbetto di cioccolato monorigine dal Venezuela, intenso e puro",
    allergensText: "Soia",
    ingredients: [],
    allergens: [],
    flags: { vegan: true, glutenFree: true, lactoseFree: true, containsEggs: false, containsNuts: false, containsAlcohol: false },
  ...
  },
  {
    ...
    seasons: ["estate"],
    image: "../assets/gelato/freutto della passione/frutto_della_passione.webp",
    detailImage: "../assets/gelato/freutto della passione/frutto_della_passione-2.webp",
