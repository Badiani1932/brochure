export const gelatoFlavors = [
  ...
  },
  {
    ...
    label: "Banana",
    seasons: ["tutti"],
    image: "../assets/gelato/_placeholder/placeholder.webp",
    detailImage: "",
    description: "Gelato alla banana",
    allergensText: "Latte",
    ingredients: [],
    allergens: [],
    flags: { vegan: false, glutenFree: true, lactoseFree: false, containsEggs: false, containsNuts: false, containsAlcohol: false },
  ...
  {
    id: "cioccoriso",
    nameKey: "flavor.cioccoriso",
    label: "Cioccoriso",
    seasons: ["tutti"],
    image: "../assets/gelato/_placeholder/placeholder.webp",
    detailImage: "",
    description: "Gelato al cioccolato e riso soffiato croccante",
    allergensText: "Latte, soia",
    ingredients: [],
    allergens: [],
    flags: { vegan: false, glutenFree: true, lactoseFree: false, containsEggs: false, containsNuts: false, containsAlcohol: false },
  ...
  {
    id: "sorbetto-tropical-summer",
    nameKey: "flavor.sorbettoTropicalSummer",
    label: "Tropical Summer",
    seasons: ["estate"],
    image: "../assets/gelato/_placeholder/placeholder.webp",
    detailImage: "",
    description: "Sorbetto tropicale con mix di frutti esotici",
    allergensText: "Può contenere soia",
    ingredients: [],
    allergens: [],
    flags: { vegan: true, glutenFree: true, lactoseFree: true, containsEggs: false, containsNuts: false, containsAlcohol: false },
